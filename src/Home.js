...
function Home() {
    ...
    return (
        <section className='h-screen  lg:h-screen lg:w-screen bg-[#bab6aa] lg:px-12 lg:py-4 font-main  lg:flex lg:flex-col'>
            <Nav text_display_delay={text_display_delay} h="10%" lg_h="10%" loaded={loaded} animate="lg:animate-show" button_one='About' href_one='about' button_two='Projects' href_two='https://github.com/Tojo07' />
